...
<command_meta>
  ...
  <description>Transform basic UI into professional design with color schemes, typography, spacing, and mobile optimization. Use when the app works but looks amateur, needs a visual refresh, or requires mobile responsiveness fixes.</description>
