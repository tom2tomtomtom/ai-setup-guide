---
description: Scaffold a full-stack app from proven starter templates (SaaS, e-commerce, marketplace, internal tools). Use when starting a new product, prototyping a business idea, or bootstrapping with auth, payments, and admin built in.
