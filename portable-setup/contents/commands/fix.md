...
<command_meta>
  <name>fix</name>
  <description>Detect and auto-fix build errors, broken features, design issues, and performance problems across your project. Use when the app won't build, something looks wrong, or you want a full health check with optional test suite.</description>
  ...
  <flags>
    <flag name="--with-tests">Run comprehensive testing suite after fixing (unit, integration, e2e)</flag>
  </flags>
</command_meta>
...
## --with-tests Flag: Comprehensive Testing

When `/fix --with-tests` is used, run the complete testing suite after fixes:
...
### Success Criteria with --with-tests
