...
<command_meta>
  ...
  <description>Build a complete app from a plain-English description with template selection, styling, and mobile optimization. Use when starting from scratch, prototyping an idea, or creating a website/store/portfolio for the first time.</description>
