---
name: plan
description: Create a comprehensive product plan with architecture, roadmap, risk assessment, and vision documents. Use when starting a new product from scratch, scoping a major feature, or needing a structured breakdown before coding begins.
---
...
When planning, also create referenceable vision documents:
...
### Using Vision in Development

Your vision is referenceable throughout development:
- In prompts: `@.claude-suite/vision/core-vision.md`
- In code comments: `@see vision/ui-patterns.md`
- In decisions: Updates logged automatically to decisions-log.md