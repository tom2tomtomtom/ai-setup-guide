---
description: Bootstrap Claude Productivity Suite into an existing codebase with documentation, workflows, and quality gates. Use when onboarding a new project, retrofitting standards to legacy code, or setting up a three-layer context system.
globs:
alwaysApply: false
version: 2.0
encoding: UTF-8
