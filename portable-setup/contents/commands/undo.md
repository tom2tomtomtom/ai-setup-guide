---
description: Safely revert the last action with automatic backup, smart git rollback, and verification that nothing else broke. Use when a commit introduced a bug, a build is broken, or you need to restore a previous working state.
---
