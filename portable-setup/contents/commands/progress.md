...
<command_meta>
  <name>progress</name>
  <description>Generate a visual project dashboard with completion metrics, accomplished milestones, and smart next-step recommendations. Use when checking project status, preparing for a standup, or deciding what to work on next.</description>
  ...
  <flags>
    <flag name="--detailed">Show technical metrics: build status, test coverage, dependencies, performance</flag>
  </flags>
</command_meta>
...
## --detailed Flag: Technical Health Dashboard

When `/progress --detailed` is used, include comprehensive technical metrics:
